                                ...
                                onPressed: () {
                                  setState(() {
                                    if (usernameController.text.isNotEmpty && emailController.text.isNotEmpty) {
                                      context.read<userListManager>().currentUser.username = usernameController.text;
                                      context.read<userListManager>().currentUser.email = emailController.text;
                                    }
                                  });
                                  Navigator.of(context).pop();
                                  usernameController.clear();
                        ...
                        builder: (context) {
                          return Container(
                            ...
                            child: Column(
                              children: [
                                SizedBox(height: 24),
                                Text("This is our project together, containing personal data of each member"),
                                ListTile(
